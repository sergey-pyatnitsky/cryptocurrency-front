...
import { CoinList, FavoritesCoinList, GetFavoriteCoins } from "../../config/api";
...
export default function FavoritesCoinsTable() {
  ...
  const fetchCoins = async () => {
    ...
    const { data } = await axios.get(GetFavoriteCoins(sessionStorage.getItem("username"), currency));
